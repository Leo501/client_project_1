cc.Class({
    ...
    onLoad: function () {
        console.log('onLoad SettingUtil.js');
        let btn_setting = cc.find('Canvas/btnNode/btn_settings');
        this.addClickEvent(btn_setting, this.node, "SettingUtil", "showSettings");
    ...
    addBtnHandler: function (btnName) {
        ...
        this.addClickEvent(btn, this.node, "SettingUtil", "onBtnClicked");
    },
