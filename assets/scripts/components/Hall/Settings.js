cc.Class({
    ...
    onLoad: function () {
        ...
        this.initButtonHandler(this.node.getChildByName("btn_close"), 3);
        this.initButtonHandler(this.node.getChildByName("btn_exit"), 1);
    ...
    initButtonHandler: function (btn, number) {
        cc.vv.utils.addClickEvent(btn, this.node, "Settings", "onBtnClicked", number);
    },
